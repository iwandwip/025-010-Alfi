        ...
        if (sessionType == "rfid") {
          ...
          if (!measurementComplete && !isProcessing) {
            ...
            if (tappedRfid == userRfid) {
              ...
              Firebase.RTDB.setString(&fbdo, "/systemStatus/hardware/currentWargaId", "");
              Firebase.RTDB.setString(&fbdo, "/systemStatus/hardware/currentWargaName", "");
